...
public class Main {
	...
	public static void main(String[] args) {
		...
		Distributore distributore = new Distributore("AllYouDrink");
		...
		inputUtente = 1;
		while (inputUtente == 1) {
			System.out.println("Premi 1 per scegliere fra l bevande calde; 2 per scegliere fra le bevande fredde; 3 per uscire dal menù: ");
